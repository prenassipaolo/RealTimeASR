...
class WakeWordEngine:
    ...
    def predict(self, audio):
        with torch.no_grad():
            ...
            return self.listener.record_chunks

    def inference_loop(self, action):
        while self.listener.record_chunks < self.max_record_chunks:
